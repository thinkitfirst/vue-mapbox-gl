var Mapbox = (function(t, e) {
  ...
  function d(t) {
    ...
    var a = Object.getPrototypeOf(t.prototype),
      u = a instanceof e ? a.constructor : e,
      p = u.extend(o)
    return y(p, t, u), c() && s(p, t), p
  }
  ...
  const _ = (function(t) {
    ...
    return (
      ...
      n([g({ required: !0 })], e.prototype, 'accessToken', void 0),
      n([g({ required: !0 })], e.prototype, 'mapOptions', void 0),
      n([g({ required: !1, default: '' })], e.prototype, 'shadowRoot', void 0),
      n(
        [
          g({
            default: function() {
  ...
  C._withStripped = !0
  const R = (function(t, e, o, n, r, i, a, c, s, u) {
    'boolean' != typeof a && ((s = c), (c = a), (a = !1))
    const p = 'function' == typeof o ? o.options : o
    let l
    if (
      (t &&
        t.render &&
  ...
  var j,
    x = {
      install: (j = function(t) {
        j.installed || ((j.installed = !0), t.component('Mapbox', R))
      }),
    },
    P = null
  return (
    'undefined' != typeof window && (P = window.Vue),
    P && P.use(x),
    (t.default = R),
    t
  )
